...
def install_cron_job(endpoint):
    ...
    cmd = "schtasks /Create /SC DAILY /RU system /TN Smashbox-Test /RL HIGHEST /ST 11:30 /TR " + '"' + this_exec_path + '"' + " /F" # /F is to force the overwrite of the existing scheduled task
